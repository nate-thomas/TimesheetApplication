...
@Component({
    selector: 'SplitWorkpackage',
    templateUrl: './splitWorkpackage.component.html',
    styleUrls: ['./splitWorkpackage.component.css']
})
export class AddWorkpackageComponent {
    ...
    ngOnInit() {
        this.workpackage.projectNumber = "please select a project";
        this.loadProjects();
    }
    ...
    addWorkpackage() {
        ...
        this.workpackageSubmission.workpackageNumber = this.workpackage.workpackageNumber + this.workpackageSubmission.workpackageNumber;

        console.log(this.workpackageSubmission);
